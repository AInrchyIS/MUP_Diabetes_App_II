...
*/
    ...
    private void sendNotification(String messageBody, String url) {
        ...
        */
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(this, 90, i, PendingIntent.FLAG_ONE_SHOT);

        Uri defaultSoundUri = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);
        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(this, getString(R.string.channel_id))
                        .setSmallIcon(R.drawable.ic_notification)
                        .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.buddy_icon))
                        .setContentTitle("Diabetes Helper")
